            ...
            produtos.map((produto) =>{
                listaProdutos +=  `<div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    ...
                    listaProdutos += `
                                ...
                                <div  class="botoes">
                                    <svg  id="lixeira" data-toggle="modal" data-target="#modal-excluirProduto" onclick="adicionaIdDelete(${produto.id});" xmlns="http://www.w3.org/2000/svg" width="30" height="50" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
